...
export const metadata: Metadata = {
  title: "Rob Kaminsky - Frontend Developer",
  description:
  ...
  authors: [{ name: "Rob Kaminsky" }],
  creator: "Rob Kaminsky",
  openGraph: {
    title: "Rob Kaminsky - Frontend Developer Portfolio",
    description:
    ...
    siteName: "Rob Kaminsky - Portfolio",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Rob Kaminsky - Frontend Developer Portfolio",
      },
    ],
    locale: "en_US",
    type: "website",
